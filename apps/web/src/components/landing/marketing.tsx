  ...
  return (
    <div>
      <div className="grid gap-8 md:grid-cols-4">
        ...
        >
          "Set up a scheduling poll in as little time as possible."
        </Mention>
        <Mention
          delay={0.5}
          logo={
        ...
        >
          "The simplest choice for availability polling for large groups."
        </Mention>
        <Mention
          delay={0.75}
          logo={
        ...
        >
          "Unique in its simplicity and requires minimum interaction time."
        </Mention>
        <Mention
          delay={1}
          logo={
        ...
        >
          "The perfect pick if you want to keep your RSVPs simple."
        </Mention>
      </div>
    </div>
  );
    ...
    >
      ...
      <div className="text-center">
        <p className="max-w-xl text-center text-lg font-medium leading-normal">
          "If your scheduling workflow lives in emails, I strongly encourage you to try and let Rallly simplify your scheduling tasks for a more organized and less stressful workday."
        </p>
        <p className="mt-1">
          <Link
            target="_blank"
